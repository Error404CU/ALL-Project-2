...
bgimage = ImageTk.PhotoImage(Image.open("TreasureMap.gif").resize((800,615)))
canvas = Canvas(window, width = 800, height = 800)
canvas.pack(padx = 0, pady = 0)
Canvas_Image = canvas.create_image(0,0, image=bgimage, anchor="nw")
...
trImgList = ['tr1(1).gif']
trImgBList = ['trB1(1).gif', 'trB2.gif']
gif1 = PhotoImage(file = 'im22(1).gif')
...
for i in range(1, len(listRbt)):
    if i % 2 == 1:
        listRbt[i] = Robot(random.randint(0, 30), random.randint(0, 30), 15, 10, "red")
